                                ...
                                <form class="form-inline pull-right" role="form">
                                    <div class="row">
                                        <div class="form-group">
                                            <input type="text" class="form-control input-sm change_width" id="pref_search_game_txt_game_fld" placeholder="search">
                                        </div>
                                        <div class="form-group header-select">
                                            <select id="pref-orderbys" class="form-control sml-select main_cat_game_fld">
                                        ...
                                        <div class="form-group header-select">
                                            <select id="pref-orderby" class="form-control sml-select sub_cats_game_fld">

                                            </select>
                                        </div>
                                        <div class="form-group btn-group-right">
                                            <button type="submit" class="btn btn-default filter-col header-btn-icon search_game_btn_fld_game">
                                    ...
                                    <div class="row">
                                        <div class="sort-select pull-right mar-none">
                                            ...
                                            <div class="form-group header-select">
                                                <select id="pref-orderby-game-univers" class="form-control sml-select">
        ...
        <div class="row r-m-p">
                    ...
                    <div class="col-xs-12 r-m-p">
                        <div>
                            <div class="list-group panel">
                                <?php echo do_shortcode('[post-type-terms-get taxonomy-name="game-universe-category" post-type-name="game-univer"]'); ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xs-9">
                ...
                <div class="main-game-wrapper">
                    <?php
                    echo do_shortcode('[show-game-peripheral-all]');
                    ?>
                </div>
            </div><!--./End -->
        </div>
