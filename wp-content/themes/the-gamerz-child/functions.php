...
register_sidebar(array(
    ...
    'id' => 'footer-widgets-8', 'description' => esc_html__('Add widgets here.', 'the-gamerz-child'),
    'before_widget' => '<section id="%1$s" class="widget %2$s">',
    'after_widget' => '</section>',
    'before_title' => '<h2 class="widget-title">',
    'after_title' => '</h2>',
...
function random_picture($atts) {
    ...
    if ($custom_query->have_posts()) {
        ...
        while ($custom_query->have_posts()) :
            ...
            if ($i == 0) {
                $html .= '<li class="active"><a href="#' . $post_id .
                        '" data-toggle="tab"><i><i class="fa fa-play" aria-hidden="true"></i></i> <i>' . get_the_title($post_id) . '</i></a></li>';


                $i = 1;
            } else {
                $html .= '<li><a href="#' . $post_id . '" data-toggle="tab"><i><i class="fa fa-play" aria-hidden="true"></i></i> <i>' . get_the_title($post_id) .
                        '</i></a></li>';
            }
        endwhile;
