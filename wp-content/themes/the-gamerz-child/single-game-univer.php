                                ...
                                <div class="row">
                                                ...
                                                if (have_rows('images')):
                                                    while (have_rows('images')): the_row();
                                                        ...
                                                        <ul class="" style="display:none;">
                                                            ...
                                                            <li><a href="<?php echo $image_2['url']; ?>" rel="prettyPhoto[gallery1]" <img src="<?php echo $image_2['url']; ?>" width="60" height="60" alt="Red round shape" /></a></li>
                                                            <li><a href="<?php echo $image_3['url']; ?>" rel="prettyPhoto[gallery1]" <img src="<?php echo $image_3['url']; ?>" width="60" height="60" alt="Red round shape" /></a></li>
                                                            <li><a href="<?php echo $image_4['url']; ?>" rel="prettyPhoto[gallery1]" <img src="<?php echo $image_4['url']; ?>" width="60" height="60" alt="Red round shape" /></a></li>
                                                            <li><a href="<?php echo $image_5['url']; ?>" rel="prettyPhoto[gallery1]" <img src="<?php echo $image_5['url']; ?>" width="60" height="60" alt="Red round shape" /></a></li>
                                                        </ul>
                                                        <?php
                                                    endwhile;
                                                endif;
                                    ...
                                    <div class="col-md-8 game-para">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-xs-6">
                                                <?php
                                                $multiplayer = get_post_meta($post->ID, 'multiplayer', true);
                                                $a = 0;
                                        ...
                                        <div class="row">
                                            <div class="row tag-padding">
                                                <div class="col-md-12">
                                                    <?php
                                                    $specArray;
                                                    $specArray['data_di_uscita'] = get_post_meta($post->ID, 'data_di_uscita', true);
                                                    $specArray['voto_degli_esperti'] = get_post_meta($post->ID, 'voto_degli_esperti', true);
                                                    $specArray['voto_acquirenti'] = get_post_meta($post->ID, 'voto_acquirenti', true);
                                                    $specArray['systema_di_pagamento'] = get_post_meta($post->ID, 'systema_di_pagamento', true);
                                                    $specArray['ambientazione'] = get_post_meta($post->ID, 'ambientazione', true);
                                                    $specArray['caratteristiche'] = get_post_meta($post->ID, 'caratteristiche', true);
                                            ...
                                            <div class="row" style="margin-bottom: 50px;">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="text-icons">
                                                        <?php
                                                        $editer_dont_likes = get_post_meta($post->ID, 'editors_didnt_like', true);
                                                        ...
                                                        ?>
                                                        <?php
                                                        $editer_dont_likes = get_post_meta($post->ID, 'editors_didnt_like_1', true);
                                                        if (!empty($editer_dont_likes)) {
                                                            echo"<p><i class='fa fa-minus-square' aria-hidden='true'></i>$editer_dont_likes</p>";
                                                        } else {
                                                        ...
                                                        ?>
                                                        <?php
                                                        $editer_dont_likes = get_post_meta($post->ID, 'editors_didnt_like_2', true);
                                                        if (!empty($editer_dont_likes)) {
                                                            echo"<p><i class='fa fa-minus-square' aria-hidden='true'></i>$editer_dont_likes</p>";
                                                        } else {
                                                        ...
                                                        ?>
                                                        <?php
                                                        $editer_dont_likes = get_post_meta($post->ID, 'editors_didnt_like_3', true);
                                                        if (!empty($editer_dont_likes)) {
                                                            echo"<p><i class='fa fa-minus-square' aria-hidden='true'></i>$editer_dont_likes</p>";
                                                        } else {
                                                        ...
                                                        ?>
                                                        <?php
                                                        $editer_dont_likes = get_post_meta($post->ID, 'editors_didnt_like_4', true);
                                                        if (!empty($editer_dont_likes)) {
                                                            echo"<p><i class='fa fa-minus-square' aria-hidden='true'></i>$editer_dont_likes</p>";
                                                        } else {
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="text-icons">
                                                        <?php
                                                        $editer_likes = get_post_meta($post->ID, 'editors_liked', true);
                                                        if (!empty($editer_likes)) {
                                                            echo"<p><i class='fa fa-plus-square' aria-hidden='true'></i>" . $editer_likes . "</p>";
                                                        } else {
                                                            
                                                        }
                                                        $editer_likes = get_post_meta($post->ID, 'landrush_quickly', true);
                                                        if (!empty($editer_likes)) {
                                                            echo"<p><i class='fa fa-plus-square' aria-hidden='true'></i>" . $editer_likes . "</p>";
                                                        } else {
                                                            
                                                        }
                                                        $editer_likes = get_post_meta($post->ID, 'editors_liked_2', true);
                                                        if (!empty($editer_likes)) {
                                                            echo"<p><i class='fa fa-plus-square' aria-hidden='true'></i>" . $editer_likes . "</p>";
                                                        } else {
                                                            
                                                        }
                                                        $editer_likes = get_post_meta($post->ID, 'editors_liked3', true);
                                                        if (!empty($editer_likes)) {
                                                            echo"<p><i class='fa fa-plus-square' aria-hidden='true'></i>" . $editer_likes . "</p>";
                                                        } else {
                                                            
                                                        }
                                                        $editer_likes = get_post_meta($post->ID, 'editors_liked4', true);
                                                        if (!empty($editer_likes)) {
                                                            echo"<p><i class='fa fa-plus-square' aria-hidden='true'></i>" . $editer_likes . "</p>";
                                                        } else {
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="simple-heading-para-content">
                                    ...
                                    ?>
                                    <?php
                                    $site_link = get_post_meta($post->ID, 'visit_official_site', true);
                                    if (!empty($site_link)) {
                    ...
                    <div class="col-xs-8">
                        <div class="tabination_all">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation"><a href="#news" aria-controls="news" role="tab" data-toggle="tab" data-post-id="<?php echo $post->ID; ?>">News</a></li>
<!--                                <li role="presentation"><a href="<?php //echo the_permalink(761);      ?>">Communities</a></li>-->
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane" id="profile">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="specs">
                                            <?php
                                            $pec_1 = get_post_meta($post->ID, 'specification_1', true);
                                            if (!empty($pec_1)) {
                                                ?>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="specs">
                                            <?php
                                            $pec_2 = get_post_meta($post->ID, 'specification_2', true);
                                            if (!empty($pec_2)) {
                                                ?>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="specs">
                                            <?php
                                            $pec_3 = get_post_meta($post->ID, 'specification_3', true);
                                            if (!empty($pec_3)) {
                                                ?>
