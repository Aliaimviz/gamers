                                        ...
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="wpb_text_column wpb_content_element">
                                                        <div class="wpb_wrapper">
                                                            <?php // echo do_shortcode("[Magazine series='0-5' category='" . $obj->term_taxonomy_id . "']"); ?>
                                                            <?php echo do_shortcode('[buying-cats-shows series="0-5"]'); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="wpb_column vc_column_container vc_col-sm-12">
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="wpb_text_column wpb_content_element">
                                                        <div class="wpb_wrapper">
                                                            <?php //echo do_shortcode("[Magazine series='5-10' style='grid' category='" . $obj->term_taxonomy_id . "']"); ?>
                                                            <?php echo do_shortcode('[buying-cats-shows series="6-10"]'); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
