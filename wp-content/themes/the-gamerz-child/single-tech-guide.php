                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix next-prev">
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        <a rel="prev" class="Raleway semi-transparent-button right" href="#"
                                           title="Archieve"><i class="fa fa-angle-left" aria-hidden="true"></i> prev</a>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        <a rel="next" href="#" class="Raleway semi-transparent-button left">next <i
